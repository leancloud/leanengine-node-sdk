...
if (!AV.Cloud.__prod) {
  Cloud.use('/' + process.env.LC_APP_ID, function(req, res) {
    res.cookie('LC_APP_ID', process.env.LC_APP_ID, {maxAge : 180000});
    res.cookie('LC_APP_KEY', process.env.LC_APP_KEY, {maxAge : 180000});
    res.cookie('LC_APP_MASTER_KEY', process.env.LC_APP_MASTER_KEY, {maxAge : 180000});
