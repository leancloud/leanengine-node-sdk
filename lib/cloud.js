...
Cloud.beforeAuthDataMatch = function(func) {
  Cloud.define('__user_before_authdata_match__User', func);
};

Cloud.beforeAuthDataCommit = function(func) {
  Cloud.define('__user_before_authdata_commit__User', func);
};
